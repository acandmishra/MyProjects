...
print(arr[0,2]) #3 will be printed
print(arr)
print(arr.shape)
...
print(arr.T) # prints the transpose of matrix arr
...
print(arr.argsort()) # gives the list of indexes in the order in which the resulting array will be sorted , the default sorting is row wise
print("\n")
